...
今回意図せず知ったが、Google Cloud コンソールから発行しているHTTPリクエストの宛先は、terraformなどで発行しているREST API([Compute Engine API](https://cloud.google.com/compute/docs/reference/rest/v1): https\://compute.googleapis.com/ )の宛先とは異なっており、  
```
